...
{
    public class JPquestionN2Controller : Controller
    {
        // GET: JPquestionN1
        ...
        MRepository<N2> dbb = new MRepository<N2>();

        public ActionResult N2QUESTION1()
        {
            var jpquestion = db.N2;
        ...
        public JsonResult N2SelectQuestion(string Ccategory)
        {
            var aa = "";
            //括號內is判斷的東西
            switch (Ccategory)
            ...
            if (aa != "綜合")
            {
                var jpquestionaa = db.N2.Where(m => m.Category == aa);
